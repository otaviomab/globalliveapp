...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    globalLiveAppAuthUserSubject.add(
      GlobalLiveAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<GlobalLiveAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  GlobalLiveAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GlobalLiveAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    globalLiveAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
GlobalLiveAppAuthUser? currentUser;
