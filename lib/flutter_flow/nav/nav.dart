...
class AppStateNotifier extends ChangeNotifier {
  ...
  GlobalLiveAppAuthUser? initialUser;
  GlobalLiveAppAuthUser? user;
  ...
  void update(GlobalLiveAppAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/sociais',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Sociais')
              : const SociaisWidget(),
        ),
        FFRoute(
          name: 'Home',
        ...
        FFRoute(
          name: 'paginaSenha',
          path: '/paginaSenha',
          builder: (context, params) => const PaginaSenhaWidget(),
        )
